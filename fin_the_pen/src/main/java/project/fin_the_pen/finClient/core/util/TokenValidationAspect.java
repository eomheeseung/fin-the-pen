...
public class TokenValidationAspect {
    ...
    @Before("execution(public * project.fin_the_pen.model.home.service.HomeService.inquiryMonth(..))) || " +
            ...
            "execution(public * project.fin_the_pen.model.assets.service.SpendGoalAmountService.*.*(..)) || " +
            "execution(public * project.fin_the_pen.model.report.service.ReportService.*.*(..))")
